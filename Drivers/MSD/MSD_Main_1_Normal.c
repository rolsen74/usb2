...
SEC_CODE void MSD_Main_1_Normal( struct USBBase *usbbase, struct MSDDevice *msddev )
{
U32 wait;
U32 mask;

	TASK_NAME_ENTER( "MSD : MSD_Main_1_Normal" );
	USBERROR( "MSD : MSD_Main_1_Normal" );
